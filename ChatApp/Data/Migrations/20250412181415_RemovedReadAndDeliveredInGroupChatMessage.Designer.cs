...
namespace ChatApp.Data.Migrations
{
    ...
    [Migration("20250412181415_RemovedReadAndDeliveredInGroupChatMessage")]
    partial class RemovedReadAndDeliveredInGroupChatMessage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatApp.Models.GroupChatMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ChatApp.Models.GroupChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ChatApp.Models.Friendship", b =>
                {
                    b.HasOne("ChatApp.Models.User", "FirstUser")
                        .WithMany()
                        .HasForeignKey("FirstUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ChatApp.Models.User", "SecondUser")
                        .WithMany()
            ...
            modelBuilder.Entity("ChatApp.Models.GroupChatMember", b =>
                {
                    b.HasOne("ChatApp.Models.GroupChat", "Group")
                        .WithMany()
